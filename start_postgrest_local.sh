...
# show configs
./postgrest-v${POSTGREST_VER} ./bin/postgrest/postgrest-v${POSTGREST_VER}.conf --dump-config

# start process
./postgrest-v${POSTGREST_VER} ./bin/postgrest/postgrest-v${POSTGREST_VER}.conf
